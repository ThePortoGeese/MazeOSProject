...
public:
    ...
    void setupUi(QMainWindow *menuWindow)
    {
        ...
        btnSolveMaze->setPalette(palette11);
        QFont font3;
        ...
        lblMazeName->setPalette(palette12);
        lblMazeName->setFont(font);

        gridLayout_6->addWidget(lblMazeName, 0, 0, 1, 2);

        lblStatus = new QLabel(pgLabView);
        lblStatus->setObjectName("lblStatus");
        QPalette palette13;
        QBrush brush28(QColor(255, 79, 0, 255));
        brush28.setStyle(Qt::SolidPattern);
        palette13.setBrush(QPalette::Active, QPalette::WindowText, brush28);
        palette13.setBrush(QPalette::Active, QPalette::Text, brush28);
        QBrush brush29(QColor(253, 78, 0, 255));
        brush29.setStyle(Qt::SolidPattern);
        palette13.setBrush(QPalette::Active, QPalette::BrightText, brush29);
        palette13.setBrush(QPalette::Inactive, QPalette::WindowText, brush28);
        palette13.setBrush(QPalette::Inactive, QPalette::Text, brush28);
        palette13.setBrush(QPalette::Inactive, QPalette::BrightText, brush29);
        palette13.setBrush(QPalette::Disabled, QPalette::BrightText, brush29);
        lblStatus->setPalette(palette13);
        lblStatus->setFont(font3);
        lblStatus->setAlignment(Qt::AlignmentFlag::AlignCenter);

        gridLayout_6->addWidget(lblStatus, 0, 2, 1, 1);
